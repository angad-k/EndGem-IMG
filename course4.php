<?php 
	...
	$sql = 'SELECT title, url, downloads, Date FROM coursecontent WHERE course = 4 ORDER BY downloads DESC';
        ...
        <div class = TopPane>
            ...
            <table class = CoursesPane>
                <tr>
                    ...
                    <td>
                        <a href = 'course4.php' class = "pressedbtn"><b>Course 4</b></a>
                    </td>
                </tr>
            </table>
            ...
            <script>
                ...
                function downloadpressed(id_btn, filep)
                {
                   ...
                   course.setAttribute("value", "course4");
