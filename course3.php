<?php 
	...
	$sql = 'SELECT title, url, downloads, Date FROM coursecontent WHERE course = 3 ORDER BY downloads DESC';
        ...
        <div class = TopPane>
            ...
            <table class = CoursesPane>
                <tr>
                    ...
                    <td>
                        <a href = 'course3.php' class = "pressedbtn"><b>Course 3</b></a>
                    </td>
                    <td>
            ...
            <script>
                ...
                function downloadpressed(id_btn, filep)
                {
                   ...
                   course.setAttribute("value", "course3");
