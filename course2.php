<?php 
	...
	$sql = 'SELECT title, url, downloads, Date FROM coursecontent WHERE course = 2 ORDER BY downloads DESC';
    ...
    <body>
        <div class = TopPane>
            ...
            <table class = CoursesPane>
                <tr>
                    <td>
                        <a href = 'index.php' class = "pressablebtn"><b>Course 1</b></a>
                    </td>
                    <td>
                        <a href = 'course2.php' class = "pressedbtn"><b>Course 2</b></a>
                    </td>
                    <td>
            ...
            <script>
                ...
                function downloadpressed(id_btn, filep)
                {
                   ...
                   course.setAttribute("value", "course2");
